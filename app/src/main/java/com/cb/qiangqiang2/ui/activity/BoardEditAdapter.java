...
import com.cb.qiangqiang2.ui.view.dragview.OnDragVHListener;
import com.cb.qiangqiang2.ui.view.dragview.OnItemMoveListener;
...
public class BoardEditAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_MY:
                ...
                myHolder.tvContent.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(final View v) {
                        if (!isEditMode) {
                            ...
                            // header 按钮文字 改成 R.string.finish
                ...
                myHolder.tvContent.setOnTouchListener(new View.OnTouchListener() {
                    @Override
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            if (isEditMode) {
                ...
                myHolder.ivCancel.setVisibility(View.INVISIBLE);
            }
    ...
    private void startEditMode(RecyclerView parent) {
        ...
        for (int i = 0; i < visibleChildCount; i++) {
            ...
            ImageView imgEdit = (ImageView) view.findViewById(R.id.iv_cancel);
            if (imgEdit != null) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements OnDragVHListener {
        ...
        public void onItemSelected() {
            tvContent.setBackgroundResource(R.drawable.bg_board_pressed);
        }
        ...
        public void onItemFinish() {
            tvContent.setBackgroundResource(R.drawable.bg_board);
        }
    }
